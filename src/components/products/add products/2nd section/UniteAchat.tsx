...
//       <Label id={id} text={"Unité d'achat*"} />
//       <SelectInput
//         value={value}
//         setValue={(val: string) => {
//           setValue(val);
    ...
    <div className="bg-red200 flex flex-col gap-3">
      ...
      <Controller
        ...
        render={({ field }) => (
          <SelectInput
            options={options_array}
            label="L'unité d'achat*"
            {...field}
            error={!!errors.uniteAchat}
            helperText={errors.uniteAchat?.message}
            value={value}
            setValue={(value: string) => {
              setValue(value);
              field.onChange(value);
              if (errors.uniteAchat) {
                clearErrors("uniteAchat");
              }
            }}
          />
        )}
